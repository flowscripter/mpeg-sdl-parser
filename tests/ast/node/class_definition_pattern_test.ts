...
// import { ClassDefinition } from "../../../src/ast/node/ClassDefinition.ts";
...
// describe("Class Definition Pattern Tests", () => {
//   test("Test class definition pattern", () => {
//     testSyntaxPattern(
...
//   test("Test class definition pattern - legacy and one parameter value", () => {
//     testSyntaxPattern(
//       CLASS_DEFINITION_RULE,
//       "legacy ClassB b(3);",
//       new ClassDefinition(
...
//   test("Test class definition pattern - multiple parameter values", () => {
//     testSyntaxPattern(
//       CLASS_DEFINITION_RULE,
//       "ClassC c(i, 3);",
//       new ClassDefinition(
...
//   test("Test class definitionx pattern - no parameter values in parenthesis fails to parse", () => {
//     expect(() =>
//       testSyntaxPattern(
//         CLASS_DEFINITION_RULE,
//         "ClassD d();",
...
//   test("Test class definition pattern - trailing comma in parameter values fails to parse", () => {
//     expect(() =>
//       testSyntaxPattern(
//         CLASS_DEFINITION_RULE,
//         "ClassD d(3,);",
