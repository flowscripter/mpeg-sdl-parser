...
// import { ArrayDefinition } from "../../../src/ast/node/ArrayDefinition.ts";
// import { ArrayElementType } from "../../../src/ast/node/ArrayElementType.ts";
...
// import { ExplicitArrayDimension } from "../../../src/ast/node/ExplicitArrayDimension.ts";
// import { Identifier } from "../../../src/ast/node/Identifier.ts";
// import { ImplicitArrayDimension } from "../../../src/ast/node/ImplicitArrayDimension.ts";
// import { LengthAttribute } from "../../../src/ast/node/LengthAttribute.ts";
// import { NumberLiteral } from "../../../src/ast/node/NumberLiteral.ts";
// import { PartialArrayDimension } from "../../../src/ast/node/PartialArrayDimension.ts";
...
// describe("Array Definition Pattern Tests", () => {
//   test("Test array definition pattern", () => {
//     testSyntaxPattern(
...
//   test("Test array definition pattern - reserved, multiple dimensions, mixed explicit and partial", () => {
//     testSyntaxPattern(
//       ARRAY_DEFINITION_RULE,
...
//   test("Test array definition pattern - implicit", () => {
//     testSyntaxPattern(
//       ARRAY_DEFINITION_RULE,
//       "MyClass a[1..3];",
//       new ArrayDefinition(
