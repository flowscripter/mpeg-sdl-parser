...
// import { ForStatement } from "../../../src/ast/node/ForStatement.ts";
...
// describe("For Statement Pattern Tests", () => {
//   test("Test for statement pattern - expression1 is expression", () => {
//     testSyntaxPattern(
//       FOR_STATEMENT_RULE,
//       "for (i=1;i<9;i++) {j++;}",
//       new ForStatement(
...
//   test("Test for statement pattern - expression1 is computed elementary type definition", () => {
//     testSyntaxPattern(
//       FOR_STATEMENT_RULE,
...
//   test("Test for statement pattern - expression1 is empty", () => {
//     testSyntaxPattern(
//       FOR_STATEMENT_RULE,
//       "for (;i<9;i++) {j++;}",
//       new ForStatement(
