...
// describe("Number Literal Pattern Tests", () => {
//   test("Test number literal pattern - integer", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "123",
//       new NumberLiteral(
...
//   test("Test number literal pattern - decimal", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "123.1",
//       new NumberLiteral(
...
//   test("Test number literal pattern - floating point", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "123.1e123",
//       new NumberLiteral(
...
//   test("Test number literal pattern - binary literal", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "0b11",
//       new NumberLiteral(
...
//   test("Test number literal pattern - binary literal with separator", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "0b0000.101",
//       new NumberLiteral(
...
//   test("Test number literal pattern - hexadecimal literal", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "0x0F",
//       new NumberLiteral(
...
//   test("Test number literal pattern - hexadecimal literal with separator", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "0x0000.FF",
//       new NumberLiteral(
...
//   test("Test number literal pattern - hexadecimal literal with separator, whitespace stripped", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       " 0x0000.FF ",
//       new NumberLiteral(
...
//   test("Test number literal pattern - multiple character literal", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "'pasp'",
//       new NumberLiteral(
...
//   test("Test number literal pattern - multiple character literal with escaping", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "'pasp\\\\'",
//       new NumberLiteral(
...
//   test("Test number literal pattern - multiple character literal concatenation", () => {
//     testSyntaxPattern(
//       NUMBER_LITERAL_RULE,
//       "'pa' 'sp'",
//       new NumberLiteral(
