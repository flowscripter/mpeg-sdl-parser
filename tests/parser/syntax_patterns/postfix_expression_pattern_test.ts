...
Deno.test("Test postfix expression pattern - class member access expression", () => {
  testSyntaxPattern(
    POSTFIX_EXPRESSION_RULE,
    "a.b",
    new PostfixExpression(
...
Deno.test("Test postfix expression pattern - class member access expression, multiple", () => {
  testSyntaxPattern(
    POSTFIX_EXPRESSION_RULE,
    "a.b.c",
    new PostfixExpression(
...
Deno.test("Test postfix expression pattern - array element access expression", () => {
  testSyntaxPattern(
    POSTFIX_EXPRESSION_RULE,
    "a[1]",
    new PostfixExpression(
...
Deno.test("Test postfix expression pattern - array element access expression, multiple", () => {
  testSyntaxPattern(
    POSTFIX_EXPRESSION_RULE,
    "a[1][2]",
    new PostfixExpression(
...
Deno.test("Test postfix expression pattern - class member access expression with postfix operator", () => {
  testSyntaxPattern(
    POSTFIX_EXPRESSION_RULE,
    "a.b++",
    new PostfixExpression(
...
Deno.test("Test postfix expression pattern - array element access expression with postfix operator", () => {
  testSyntaxPattern(
    POSTFIX_EXPRESSION_RULE,
    "a[1]++",
    new PostfixExpression(
...
Deno.test("Test postfix expression pattern - class member and array element access expression, multiple mixed", () => {
  testSyntaxPattern(
    POSTFIX_EXPRESSION_RULE,
    "a[1][2].b.c",
    new PostfixExpression(
