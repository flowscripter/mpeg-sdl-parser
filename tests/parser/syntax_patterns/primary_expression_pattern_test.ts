...
Deno.test("Test primary expression pattern - number literal", () => {
  testSyntaxPattern(
...
Deno.test("Test primary expression pattern - number literal in parenthesis", () => {
  testSyntaxPattern(
    PRIMARY_EXPRESSION_RULE,
    "(1)",
...
Deno.test("Test primary expression pattern - identifier in parenthesis", () => {
  testSyntaxPattern(
    PRIMARY_EXPRESSION_RULE,
    "(i)",
    new PrimaryExpression(
