...
export const COMMENT_PATTERN = '//' + '(?:' + BASIC_CHARACTER_SET_PATTERN + '|' + WHITESPACE_PATTERN + ')*';
...
export const LITERAL_FLOATING_POINT_PATTERN = '(?:0|' + POSITIVE_INTEGER_PATTERN + ')' + '\\.' + DIGIT_CHARACTER_PATTERN + '*e(?:' + OPERATOR_PLUS_PATTERN +  '|' + OPERATOR_MINUS_PATTERN + ')?' + LITERAL_INTEGER_PATTERN;
